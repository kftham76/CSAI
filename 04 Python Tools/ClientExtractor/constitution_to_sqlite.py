"""Convert the constitutions workbook into a standalone SQLite database."""
...
SOURCE_FILE = Path(r"D:\CSAI_DATA\Database\Constitutions.xlsx")
SHEET_NAME = "Sheet1"
DATABASE_FILE = Path(r"C:\CSAI_OS\04 Python Tools\DB\constitutions.db")
