...
def _scalar_values(context: DocumentContext) -> dict[str, str]:
    ...
    values = {
        # The retained first-AGM source still carries this drafting annotation.
        # Remove it only from generated output so the source template remains
        # immutable while preserving the established production contract.
